...
Abstraction
=Composition=
#+BEGIN_SRC plantuml :file Image/composition.png
hidefootbox
a -> b : f
b -> c : g
a -> c : f . g
...
#+RESULTS:
[[file:Image/composition.png]]

=Identity=
f . id_a  = f
id_a . f = f
#+BEGIN_SRC plantuml :file Image/identity.png
hidefootbox
a -> a : id_a
a -> b : f
#+END_SRC
...
#+RESULTS:
[[file:Image/identity.png]]

=Associativity=
h . (g . f) = (h . g) . f
#+BEGIN_SRC plantuml :file Image/Associativity.png
hidefootbox
a -> b : f
b -> c : g
c -> d : h
